...
function CarsDetails() {
  ...
  return (
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-[59] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4 ">
              ...
              <div className="grid gird-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    placeholder=""
                    className="w-full px-4 pt-6 pb-2 bg-[#121212] text-white rounded-md border border-[#f5b754]/20 outline-none focus-:ing-2 focus-ring-[#f5b754] transition duration-200"
                  />
                  <label className="absolute left-4 top-2 text-sm text-gray-400 pointer-events-none transition-all">
                    Phone*
                  </label>
